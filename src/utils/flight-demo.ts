...
export class FlightDemo {
  ...
  private static createSampleQuoteRequest(): QuoteRequest {
    return {
      id: 'qr_sample_001',
      requestCode: 'QR-CLIENT-DEMO-20241201-A1B2',
      clientUserCode: 'CLIENT-DEMO',
      tripType: 'oneWay',
      routing: {
  ...
  private static createSampleOffer(quoteRequest: QuoteRequest): Offer {
    ...
    return {
      offerId: 'QT-OP-JETS-DEMO-20241201-A1B2',
      operatorUserCode: 'OP-JETS-DEMO',
  ...
  private static createSampleBooking(quoteRequest: QuoteRequest, offer: Offer): Booking {
    return {
      ...
      bookingId: 'BK-OP-JETS-DEMO-20241201-C3D4',
      ...
      operator: {
        ...
        operatorName: 'Demo Jets LLC',
      },
      aircraft: {
        id: 'AC-OP-JETS-DEMO-G650',
        registration: 'N123DJ',
        make: 'Gulfstream',
        model: 'G650',
        maxPassengers: 14,
