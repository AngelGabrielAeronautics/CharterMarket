...
import { QuoteRequestFormData, TripType, CabinClass } from '@/types/flight';
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="flex items-center space-x-2">
          <input type="checkbox" {...register('flexibleDates')} className="form-checkbox" />
          <label className="text-sm text-gray-600">Flexible Dates (+/- 2 days)</label>
        </div>
      </div>
